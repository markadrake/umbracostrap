...
(function () {
	...
	var controllerName = "umbracostrapIconsPicker";
	var controller = function ($scope) {
		$scope.icons = data;
		$scope.iconHref = (icon) => `/app_plugins/umbracostrap/propertyEditors/bootstrap-icons.svg#${icon}`;
	};

	angular.module("umbraco").controller(controllerName, controller);

	/*
	 * This data is pulled from the Bootstrap Icons website.
	 * TODO: Should store this as a JSON file.
